...
class ClientPrefs {
	...
	public static var cherryVolume:Bool = false;
	public static var enchantVolume:Bool = false;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.cherryVolume = cherryVolume;
		FlxG.save.data.enchantVolume = enchantVolume;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.cherryVolume != null) {
			cherryVolume = FlxG.save.data.cherryVolume;
		}
		if(FlxG.save.data.enchantVolume != null) {
			enchantVolume = FlxG.save.data.enchantVolume;
		}
