...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		switch(easterEgg.toUpperCase())
		{
			...
			//EDIT THIS ONE IF YOU'RE MAKING A SOURCE CODE MOD!!!!
			//EDIT THIS ONE IF YOU'RE MAKING A SOURCE CODE MOD!!!!
				gfDance.frames = Paths.getSparrowAtlas('gf');
				gfDance.animation.addByIndices('danceLeft', 'gfheadbop', [12, 1, 2, 3, 4, 5, 6], "", 24, false);
				gfDance.animation.addByIndices('danceRight', 'gfheadbop', [7, 8, 9, 10, 11, 12], "", 24, false);
		}
