...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Getting Over It', 0.2], //From 0% to 19%
		...
		['NO WAY!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	override public function create()
	{
		...
		if(ClientPrefs.cherryVolume) CoolUtil.precacheSound('cherry');
		if(ClientPrefs.enchantVolume) CoolUtil.precacheSound('enchant');
	...
	/*function openChartEditor()
		{
			PlayState.SONG = Song.loadFromJson('no' + '', 'no');
	...
	function goodNoteHit(note:Note):Void
	{
		...
		if (!note.wasGoodHit)
		{
			 if (ClientPrefs.cherryVolume)
			{
				FlxG.sound.play(Paths.sound('cherry'), ClientPrefs.cherryVolume);
			} 
